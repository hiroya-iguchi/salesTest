...
public class CalculateSales {
	...
	// 降順・出力メソッド
	public static boolean sortOutput(Map<String, Long> map, String args, String outName,
	...
	// 定義ファイル読み込みメソッド
	public static boolean fileRead(String args, String lstName, String match, int x, String exist,
			HashMap<String, String> hashMap, Map<String, Long> map) {
	...
	public static void main(String[] args) {
		...
		// 1.支店定義ファイル読み込み
		if (fileRead(args[0], "branch.lst", "^[0-9]*$", 3, "支店定義ファイル", branchNameMap, branchSaleMap) == false) {
			return;
		}

		// 2.商品定義ファイル読み込み
		if (fileRead(args[0], "commodity.lst", "^[0-9a-zA-Z]*$", 8, "商品定義ファイル", commodityNameMap,
				commoditySaleMap) == false) {
			return;
		}
		// 3.集計
